...
Steps
1. Clone the repo
2. Set up a pythonanywhere account (https://www.pythonanywhere.com/)
...
Notes
- Error messages are directly printed onto the UI which is not good security practice. But this is open-source anyway so...
